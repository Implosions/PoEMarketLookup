...
namespace PoEMarketLookup.PoE.Parsers
{
    public static class Utils
    {
        ...
        private static Regex _reBodyArmor = 
            new Regex(@"\b(Vest|Chestplate|Plate|Jerkin|Leather|Tunic|Garb|Robe|Vestment|Regalia|Wrap|Brigandine|Doublet|Armour|Lamellar|Wyrmscale|Dragonscale|Coat|Ringmail)\b");

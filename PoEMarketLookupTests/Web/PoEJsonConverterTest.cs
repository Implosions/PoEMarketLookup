...
namespace PoEMarketLookupTests.Web
{
    ...
    public class PoEJsonConverterTest
    {
        ...
        [TestMethod]
        public void IndexHasValueOf1DayIfListTimeIsOneDay()
        {
            var vm = new ItemViewModel();
            var converter = new PoEJsonConverter(vm, time: ListTime.OneDay);
            string json = converter.SerializeSearchParameters();
            var jo = JToken.Parse(json);
            var param = jo["query"]["filters"]["trade_filters"]["filters"]["indexed"]["option"];
        ...
        [TestMethod]
        public void IndexHasValueOf2WeeksIfListTimeIsTwoWeeks()
        {
            var vm = new ItemViewModel();
            var converter = new PoEJsonConverter(vm, time: ListTime.TwoWeeks);
            string json = converter.SerializeSearchParameters();
            var jo = JToken.Parse(json);
            var param = jo["query"]["filters"]["trade_filters"]["filters"]["indexed"]["option"];
        ...
        [TestMethod]
        public void IndexHasValueOf1MonthIfListTimeIsOneMonth()
        {
            var vm = new ItemViewModel();
        ...
        [TestMethod]
        public void IndexHasValueOf2MonthsIfListTimeIsTwoMonths()
        {
            var vm = new ItemViewModel();
            var converter = new PoEJsonConverter(vm, time: ListTime.TwoMonths);
            string json = converter.SerializeSearchParameters();
            var jo = JToken.Parse(json);
            var param = jo["query"]["filters"]["trade_filters"]["filters"]["indexed"]["option"];

...
namespace PoEMarketLookupTests.Parsing
{
    ...
    public class UtilsTest
    {
        ...
        [TestMethod]
        public void FindItemTypeReturnsBodyArmorTypeForGarbs()
        {
            var type = Utils.FindItemType(CreateTestArmor("Cutthroat's Garb"));

            Assert.AreEqual(PoEItemType.BodyArmor, type);
        }

        [TestMethod]
        public void FindItemTypeReturnsBodyArmorTypeForRobes()
        {
            var type = Utils.FindItemType(CreateTestArmor("Simple Robe"));
        ...
        [TestMethod]
        public void FindItemTypeReturnsBodyArmorTypeForArmours()
        {
            var type = Utils.FindItemType(CreateTestArmor("Full Scale Armour"));
        ...
        [TestMethod]
        public void FindItemTypeReturnsBodyArmorTypeForCoats()
        {
            var type = Utils.FindItemType(CreateTestArmor("Ringmail Coat"));
        ...
        [TestMethod]
        public void FindItemTypeReturnsBodyArmorTypeForJackets()
        {
            var type = Utils.FindItemType(CreateTestArmor("Padded Jacket"));
